...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
	...
	/obj/item/storage/backpack/marine/satchel/scout_cloak = list(CAT_LEDSUP, "Scout Cloak", 25, "yellow"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
	...
	/obj/item/clothing/gloves/defibrillator = list(CAT_FCSUP, "Advanced medical gloves", 4, "yellow"),
