...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/supply_beacon = list(CAT_ENGSUP, "Supply beacon", 5, "black"),
...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
		...
		/obj/item/clothing/gloves/defibrillator = list(CAT_MEDSUP, "Advanced medical gloves", 5, "black"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/suit/surgical = list(CAT_SMR, "Surgical apron", 0, "synth-storage"),
		/obj/item/clothing/suit/storage/labcoat = list(CAT_SMR, "Labcoat", 0, "synth-storage"),
		/obj/item/clothing/suit/storage/labcoat/researcher = list(CAT_SMR, "Researcher's labcoat", 0, "synth-storage"),
